  ...
  function (Crafty, window, document) {
    ...
    Crafty.c("2D", {
      ...
      _rotate: function (v) {
        ...
        var x0 = o.x + (this._x - o.x) * ct + (this._y - o.y) * st,
          ...
          x2 =
            o.x +
            (this._x + this._w - o.x) * ct +
            (this._y + this._h - o.y) * st,
          y2 =
            o.y -
            (this._x + this._w - o.x) * st +
            (this._y + this._h - o.y) * ct,
    ...
    Crafty.polygon.prototype = {
      ...
      rotate: function (e) {
        ...
        for (; i < l; i++) {
          ...
          x =
            e.o.x + (current[0] - e.o.x) * e.cos + (current[1] - e.o.y) * e.sin;
          y =
            e.o.y - (current[0] - e.o.x) * e.sin + (current[1] - e.o.y) * e.cos;
        ...
        if (Crafty.support.canvas) {
          ...
          this.requires("Collision").bind("EnterFrame", function () {
            ...
            for (var p in this.map.points) {
              ctx.lineTo(
                Crafty.viewport.x + this.map.points[p][0],
      ...
      viewport: {
        ...
        scale: (function () {
          ...
          return function (amt) {
            ...
            Crafty.viewport.pan("reset");
            Crafty.stage.inner.style["transform"] = Crafty.stage.inner.style[
              prop
    ...
    Crafty.c("Draggable", {
      ...
      init: function () {
        ...
        this._ondrag = function (e) {
          ...
          if (this._dir) {
            var len =
              (pos.x - this._origMouseDOMPos.x) * this._dir.x +
      ...
      speed: function (speed) {
        for (var k in this._keyDirection) {
          ...
          this._keys[keyCode] = {
            x:
              Math.round(
                Math.cos(this._keyDirection[k] * (Math.PI / 180)) *
                  1000 *
                  speed.x
              ) / 1000,
            y:
              Math.round(
                Math.sin(this._keyDirection[k] * (Math.PI / 180)) *
                  1000 *
                  speed.y
              ) / 1000,
          };
    ...
    Crafty.c("SpriteAnimation", {
      ...
      animate: function (reelId, fromx, y, tox) {
        ...
        if (arguments.length < 4 && typeof fromx === "number") {
          ...
          this._frame = {
            ...
            numberOfFramesBetweenSlides: Math.ceil(
              duration / currentReel.length
            ),
      ...
      updateSprite: function () {
        ...
        if (
          this._frame.frameNumberBetweenSlides++ ===
          data.numberOfFramesBetweenSlides
        ) {
            ...
            while (i < l) {
              ...
              if (
                ...
                merger = {
                  ...
                  _w:
                    Math.max(current._x, next._x) +
                    Math.max(current._w, next._w),
                  _h:
                    Math.max(current._y, next._y) +
                    Math.max(current._h, next._h),
                };
      ...
      isometric: {
        ...
        pos2px: function (x, y) {
          return {
            left: ~~(
              x * this._tile.width +
              (y & 1) * this._tile.width * this._tile.ratio
            ),
        ...
        px2pos: function (left, top) {
          ...
          // };
          var x =
            left / this._tile.width -
            (top & 1) / this._tile.width / this._tile.ratio;
          if (x < 0) x = x - 1;
          return {
            x: ~~x,
            y: ~~(top / this._tile.height / this._tile.ratio),
        ...
        centerAt: function (x, y) {
          if (typeof x == "number" && typeof y == "number") {
            ...
            Crafty.viewport.x =
              Crafty.viewport.width / 2 -
              this._tile.width * this._tile.ratio -
              center.left;
            Crafty.viewport.y =
              Crafty.viewport.height / 2 - this._tile.height - center.top;
          }
          ...
          var vp = {
            ...
            y: {
              start: -Crafty.viewport.y - this._tile.height * this._tile.ratio,
                ...
                -Crafty.viewport.y +
                Crafty.viewport.height +
                this._tile.height * this._tile.ratio,
            },
          };
        ...
        polygon: function () {
          return [
            [this._tile.width * this._tile.ratio, 0],
            [this._tile.width, this._tile.height * this._tile.ratio],
            [this._tile.width * this._tile.ratio, this._tile.height],
            [0, this._tile.height * this._tile.ratio],
          ];
        },
      },
    });
