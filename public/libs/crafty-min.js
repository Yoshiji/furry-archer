...
(function (k, w, h) {
    ...
    timer: {
      ...
      stop: function () {
        ...
        var z =
          ...
          k.msCancelRequestAnimationFrame ||
          null;
        if (z) {
          z(i);
        }
        ...
        save: function (key, type, data) {
          ...
          try {
            var trans = db.transaction([type], transactionType.READ_WRITE),
              ...
              request = store.put({ data: str, timestamp: t, key: key });
          } catch (e) {
            console.error(e);
          }
        },
    ...
    viewport: {
      ...
      zoom: (function () {
        ...
        function enterFrame() {
          if (dur > 0) {
            ...
            var new_s = { width: act.width * zoom, height: act.height * zoom },
              diff = {
      ...
      scale: (function () {
        ...
        return function (amt) {
          ...
          Crafty.viewport.pan("reset");
          Crafty.stage.inner.style.transform = Crafty.stage.inner.style[prop] =
  ...
  Crafty.extend({
    isometric: {
      ...
      area: function () {
        ...
        return {
          x: { start: start.x, end: end.x },
          y: { start: start.y, end: end.y },
        };
      },
    },
  });
  Crafty.extend({
    diamondIso: {
      ...
      centerAt: function (x, y) {
        var pos = this.pos2px(x, y);
        Crafty.viewport.x =
          -pos.left + Crafty.viewport.width / 2 - this._tile.width;
      ...
      area: function (offset) {
        ...
        var grid = [];
        for (
          var y = vp._y, yl = vp._y + vp._h;
          y < yl;
          y += this._tile.height / 2
        ) {
          for (
            var x = vp._x, xl = vp._x + vp._w;
            x < xl;
  ...
  Crafty.c("Particles", {
    ...
    _Particles: {
      ...
      initParticle: function (particle) {
        ...
        var newAngle =
          (this.angle + this.angleRandom * this.RANDM1TO1()) * (Math.PI / 180);
  ...
  Crafty.c("Text", {
    _text: "",
    _textFont: { type: "", weight: "", size: "", family: "" },
    ready: true,
    init: function () {
      this.requires("2D");
      this.bind("Draw", function (e) {
